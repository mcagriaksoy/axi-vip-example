...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MASK"

}

proc update_PARAM_VALUE.MASK { PARAM_VALUE.MASK } {
	# Procedure called to update MASK when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MASK { PARAM_VALUE.MASK } {
	# Procedure called to validate MASK
	return true
}
...
proc update_MODELPARAM_VALUE.MASK { MODELPARAM_VALUE.MASK PARAM_VALUE.MASK } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MASK}] ${MODELPARAM_VALUE.MASK}
}
